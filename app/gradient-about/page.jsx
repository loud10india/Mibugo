...
export const metadata = {
    title: "Gradient About || Resonance &mdash; One & Multi Page React Nextjs Creative Template",
                                    ...
                                    <div className='col-lg-8 offset-lg-2 text-center'>
                                        <div className='row text-start text-gray mb-80 mb-sm-60'>
                                            <div className='col-md-6 mb-sm-20 wow linesAnimInLong' data-splitting='lines'>
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. In maximus ligula semper metus pellentesque
                                                mattis. Maecenas volutpat, diam enim sagittis quam, id porta quam. Sed id dolor consectetur fermentum
                                                nibh volutpat.
                                            </div>
                                            <div className='col-md-6 wow linesAnimInLong' data-splitting='lines'>
                                                Etiam sit amet fringilla lacus. Pellentesque suscipit ante ullamcorper pulvinar neque porttitor
                                                integer lectus. Praesent sed nisi eleifend, fermentum orcilorem amet, iaculis libero lorem. Donec vel
