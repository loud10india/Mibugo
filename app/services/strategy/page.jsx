...
import { stepsItems4, stepsItems3 } from "@/data/steps";
                                ...
                                <div className='row'>
                                    <div className='col-lg-5 mb-md-50 mb-xs-30'>
                                        <div className='lead-alt wow linesAnimIn' data-wow-offset={0} data-splitting='lines'>
                                            Struggling to Plan Your Business’s Next Steps?
                                        </div>
                                    </div>
                                    <div className='col-lg-7 wow linesAnimIn' data-wow-offset={0} data-splitting='lines'>
                                        <p className='mb-0'>
                                            At Mibugo Consulting, we empower startups and SMEs with data-driven strategies to thrive in competitive
                                            markets. Our Comprehensive Business Strategy services align your vision with actionable plans, helping you
                                ...
                                <div className='row'>
                                    ...
                                    <div className='col-lg-5 col-xl-5 d-flex align-items-center '>
                                        <div className='w-100'>
                                            ...
                                            <h3 className='section-title mb-30'>Your Strategic Blueprint for Success</h3>
                                            <p className='section-descr '>
                                                We offer a suite of services designed to address every aspect of business strategy. From market
                                                analysis to risk management, our tailored solutions ensure you’re prepared for challenges while
                            ...
                            <div className='row mb-80 mb-sm-60'>
                                ...
                                <div className='col-lg-6 pt-20 pt-md-30'>
                                    <p className='text-gray mb-0'>
                                        We simplify your journey to sustainable growth with a focused methodology designed for measurable impact and
                                        long-term success.
                                    </p>
                                </div>
                            </div>
                                            ...
                                            <div className='col-md-8 text-center text-md-start mb-sm-20 d-md-flex'>
                                                ...
                                                <div className='d-flex align-items-center pt-2 pt-md-0'>
                                                    <p className='section-descr-medium w-100 mb-0'>
                                                        Turn your vision into action—schedule a consultation with Mibugo Consulting today!
                                                    </p>
                                                </div>
                                            </div>
