...
import { stepsItems5, stepsItems3 } from "@/data/steps";
                            ...
                            <div className='container'>
                                <div className='row'>
                                    ...
                                    <div className='col-lg-7 wow linesAnimIn' data-wow-offset={0} data-splitting='lines'>
                                        <p className='mb-0'>
                                            At Mibugo Consulting, we specialize in delivering targeted marketing solutions that drive measurable
                                            results. Our strategies are designed to identify and engage your ideal customers, increasing visibility,
                                ...
                                <div className='row'>
                                    ...
                                    <div className='col-lg-5 col-xl-5 d-flex align-items-center '>
                                        <div className='w-100'>
                                            ...
                                            <h3 className='section-title mb-30'>Reach Your Ideal Customer with Precision</h3>
                                            <p className='section-descr '>
                                                Our marketing solutions are data-driven and designed to maximize your brand’s impact across the right
                                                channels.
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div className='container position-relative'>
                            <div className='row mb-80 mb-sm-60'>
                                ...
                                <div className='col-lg-6 pt-20 pt-md-30'>
                                    <p className='text-gray mb-0'>We focus on delivering results with a targeted, measurable approach.</p>
                                </div>
                            </div>
                            {/* Steps Grid */}
                                            ...
                                            <div className='col-md-8 text-center text-md-start mb-sm-20 d-md-flex'>
                                                ...
                                                <div className='d-flex align-items-center pt-2 pt-md-0'>
                                                    <p className='section-descr-medium w-100 mb-0'>
                                                        Maximize your marketing impact—schedule a consultation with Mibugo Consulting today!
                                                    </p>
                                                </div>
                                            </div>
