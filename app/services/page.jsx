                                    ...
                                    <div className='row text-center'>
                                        <div className='col-md-8 offset-md-2'>
                                            ...
                                            <p className='section-descr-medium mb-50 mb-sm-40'>
                                                Looking for exclusive creative services? Contact us and get free online consultation for your brand or
                                                your client's brand.
                                            </p>
                                ...
                                <div className='row wow fadeInUp'>
                                    <div className='col-md-7 col-lg-6 col-xl-5'>
                                        ...
                                        <p className='mb-50 mb-sm-40'>
                                            Praesent venenatis justo in ultrices tempor. Donec maximus, dolor a condimentum congue, tellus nisi dictum
                                            magna, uttere lorem ipsum viverra massa ex sit amet nulla. Duis lobortis nisl sed aliquam sollicitudin.
                                        </p>
                            ...
                            <div className='container position-relative'>
                                <div className='row position-relative'>
                                    <div className='col-md-6 col-lg-5 mb-md-50 mb-sm-30'>
                                        <h3 className='section-title mb-30'>What our area of&nbsp;expertise?</h3>
                                        <p className='text-gray mb-0'>
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam pulvinar vitae neque et porttitor. Integer
                                            non dapibus diam, ac eleifend lectus. In maximus ligula semper metus pellentesque mattis. Maecenas
