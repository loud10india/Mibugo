                                ...
                                <div className='row'>
                                    <div className='col-lg-5 mb-md-50 mb-xs-30'>
                                        <div className='lead-alt wow linesAnimIn' data-wow-offset={0} data-splitting='lines'>
                                            Is Your Business Reaching Its Full Profit Potential?
                                        </div>
                                    </div>
                                    <div className='col-lg-7 wow linesAnimIn' data-wow-offset={0} data-splitting='lines'>
                                        <p className='mb-0'>
                                            At Mibugo Consulting, we specialize in helping startups and SMEs optimize their operations for maximum
                                            profitability. Our Profit Maximization Strategies are designed to identify inefficiencies, reduce costs,
                                            and drive sustainable revenue growth, ensuring your business thrives in any market condition.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className='row'>
                                    ...
                                    <div className='col-lg-5 col-xl-5 d-flex align-items-center '>
                                        <div className='w-100'>
                                            ...
                                            <h3 className='section-title mb-30'>Strategic Financial Insights for Maximum ROI</h3>
                                            <p className='section-descr '>
                                                Our financial strategies focus on uncovering opportunities, refining resource allocation, and
                                                optimizing operations to deliver sustainable returns while maintaining fiscal responsibility.
                                            </p>
                                        </div>
                                    </div>
                                    {/* End Section Text */}
                                    ...
                                    <div className='col-lg-7 col-xl-6 offset-xl-1 d-flex align-items-center'>
                                        <div className='position-relative'>
                                            ...
                                            <div className='position-relative overflow-hidden'>
                                                <Image
                                                    src='/assets/images/Profit 2.jpg'
                            ...
                            <div className='row mb-80 mb-sm-60'>
                                ...
                                <div className='col-lg-6 pt-20 pt-md-30'>
                                    <p className='text-gray mb-0'>
                                        We streamline your path to increased profitability with an effective methodology focused on sustainable
                                        results.
                                    </p>
                                </div>
                            </div>
                                            ...
                                            <div className='col-md-8 text-center text-md-start mb-sm-20 d-md-flex'>
                                                ...
                                                <div className='d-flex align-items-center pt-2 pt-md-0'>
                                                    <p className='section-descr-medium w-100 mb-0'>
                                                        Ready to elevate your business profits? Schedule a consultation with Mibugo Consulting today!
                                                    </p>
                                                </div>
                                            </div>
