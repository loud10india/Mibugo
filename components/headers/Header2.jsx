                ...
                <ul className='items-end clearlist local-scroll'>
                    <li>
                        <a href='#contact' className='opacity-1 no-hover'>
                            <span className='btn btn-mod btn-small btn-border btn-border-white btn-circle ttn' data-btn-animate='y'>
                                <span className='btn-animate-y'>
                                    <span className='btn-animate-y-1'>
                                        Let’s talk <i className='icon-arrow-right1 size-16' aria-hidden='true'></i>
                                    </span>
