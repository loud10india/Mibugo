              ...
              <div className="composition-7">
                <div className="composition-7-image-1">
                  ...
                  <div className="composition-7-inner">
                    <Image
                      src="/assets/images/demo-gradient/section-image-1.webp"
                ...
                <div className="composition-7-image-2">
                  ...
                  <div className="composition-7-inner">
                    <Image
                      src="/assets/images/demo-gradient/section-image-2.webp"
                      alt="Image Description"
                      width={398}
                      height={482}
                    />
                ...
                <div className="composition-7-image-3">
                  ...
                  <div className="composition-7-inner">
                    <Image
                      src="/assets/images/demo-gradient/section-image-3.webp"
                      alt="Image Description"
                      width={460}
                      height={308}
                    />
                ...
                <div className="composition-7-image-4">
                  ...
                  <div className="composition-7-inner">
                    <Image
                      src="/assets/images/demo-gradient/section-image-4.webp"
                      alt="Image Description"
                      width={368}
                      height={456}
                    />
