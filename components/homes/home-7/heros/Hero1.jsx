                    ...
                    <div className='row'>
                        ...
                        <div className='col-lg-6 d-flex align-items-center mb-md-60 mb-sm-40'>
                            <div className='w-100 text-center text-lg-start'>
                                <h1 className='hs-title-1 mb-40 mb-sm-20 wow fadeInUp'>Empowering Business Success</h1>
                                <div className='row'>
                                    <div className='col-lg-10'>
                                        <p className='section-descr mb-50 mb-sm-40 wow fadeInUp' data-wow-delay='0.15s'>
                                            Guiding SMEs and startups with expert strategies in marketing, HR, finance and operations for sustainable
                            ...
                            <div className='w-100 ps-xl-3'>
                                <div className='composition-6'>
                                    <div className='composition-6-decoration-1'>
                                        <Image src='/assets/images/demo-gradient/decoration-1.svg' alt='Image Description' width={151} height={131} />
                                    </div>
                                    ...
                                    <div className='composition-6-image'>
                                        <Image
                                            src='/assets/images/demo-gradient/mibugo-4.jpg'
