        ...
        <div className='container position-relative'>
            <div className='row mb-80 mb-sm-60'>
                <div className='col-lg-8 offset-lg-2 text-center mb-md-30'>
                    <h2 className='section-caption-gradient mb-20 mb-xs-10'>Latest News</h2>
                    <div className='section-line-gradient mx-auto mb-20' />
                    <h3 className='section-title mb-40 mb-sm-30'>Check the latest news about our company in our blog.</h3>
                    <p className='text-gray mb-0'>
                        Praesent venenatis justo in ultrices tempor. Donec maximus, dolor a condimentum congue, tellus nisi dictum magna, ut viverra
                        massa ex sit amet nulla. Duis lobortis nisl sed aliquam sollicitudin.
                    </p>
                </div>
                <div className='col-lg-2 d-flex align-items-end'>
                    <div className='local-scroll text-center text-lg-end w-100'>
                        <Link href={`/gradient-blog`} className='link-hover-anim link-gradient' data-link-animate='y'>
            ...
            <div className='row mt-n30'>
                ...
                {blogs7.map((item, index) => (
                    <div key={index} className='post-prev-3 gradient col-12 col-lg-10 offset-lg-1 col-xl-6 offset-xl-0 mt-30'>
                        <div className='post-prev-3-container d-block d-sm-flex'>
                            <div className='post-prev-3-img'>
                                <a href='#'>
                                    <Image src={item.imgSrc} alt={item.imgAlt} width={400} height={498} className='wow scaleOutIn' />
                                </a>
                            </div>
