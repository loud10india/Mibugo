...
export default function Home5({ onePage = false, dark = false }) {
    return (
        <>
                            ...
                            <div>
                                <div className='wow linesAnimIn' data-splitting='lines'>
                                    ...
                                    <div className='text-gray mb-30 mb-sm-20'>
                                        <p className='mb-0'>
                                            Design elements are the basic units of any design which form its structure and convey visual messages.
                                            Color is the result of light reflecting back from an object to our eyes. Curvilinear shapes are composed
                                            of curved lines and smooth edges. Lines can be vertical, horizontal, diagonal, or curved. They can be any
                                            width or texture, and can be continuous, implied, or broken. On top of that, there are different types of
                                            lines aside from the ones previously mentioned.
                                        </p>
                                    </div>
                                </div>
            ...
            <div className='page-section overflow-hidden'>{dark ? <MarqueeDark /> : <Marquee />}</div>
            <section
                        ...
                        <div className='col-md-6 offset-xl-1 d-flex align-items-center'>
                            <div className='row small-section'>
                                <div className='col-xl-11'>
                                    <h2 className='section-title mb-30 mb-sm-20'>Looking for digital services?</h2>
                                    <div className='text-gray mb-30 mb-sm-20'>
                                        <p className='mb-0'>
            ...
            <div className='page-section overflow-hidden'>{dark ? <MarqueeDark /> : <Marquee />}</div>
            <section className={`page-section pt-0  scrollSpysection  ${dark ? "bg-dark-1 light-content" : ""} `} id='services'>
                <Service />
            </section>
            <hr className='mt-0 mb-0' />
            <section className={`page-section pb-0  scrollSpysection  ${dark ? "bg-dark-1 light-content" : ""} `} id='portfolio'>
                    ...
                    <div className='row mb-70 mb-sm-50'>
                        <div className='col-md-8 offset-md-2 col-lg-6 offset-lg-3 text-center'>
                            ...
                            <div className='text-gray'>
                                The action centric perspective is a label given to a collection of concepts, which are antithetical to the rational
                                model.
                            </div>
                        </div>
                    </div>
                ...
                <div className='container'>
                    <div className='row mb-n10'>
                        <div className='col-md-6 offset-md-1 col-lg-5 offset-lg-2 mb-sm-30 text-center text-md-start'>
                            <h2 className='section-title-small mb-0'>Like our creative works?</h2>
                        </div>
                ...
                <div className='container'>
                    <div className='row mb-70 mb-sm-50'>
                        <div className='col-md-8 offset-md-2 col-lg-6 offset-lg-3 text-center'>
                            ...
                            <div className='text-gray'>
                                Paints such as oil, acrylic, and encaustic are thicker and more opaque and are used to create impressions on the
                                surface.
                            </div>
                        </div>
                    </div>
