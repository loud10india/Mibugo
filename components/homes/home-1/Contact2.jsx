                ...
                <div className='col-lg-6'>
                    <div className='pe-lg-5'>
                        ...
                        <p className='text-gray mb-0'>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur finibus urna, quis facilisis tortor. Sed imperdiet sed
                            massa sed consequat. Vestibulum vehicula commodo nibh sit amet sodales. Nunc a neque rutrum mi convallis rhoncus sodales
                            at augue. Donec egestas ultrices ullamcorper.
                        </p>
                    </div>
                </div>
                <div className='col-lg-6'>
                    <div className='row mb-60 mb-sm-50'>
                        ...
                        <div className='col-sm-6 mb-xs-30 d-flex align-items-stretch'>
                            <div className='alt-features-item border-left mt-0 wow fadeScaleIn' data-wow-delay='.3s'>
                                ...
                                <div className='alt-features-descr clearlinks'>
                                    <div>
                                        <a href='mailto:info@mibugo.com'>info@mibugo.com</a>
                                    </div>
                        ...
                        <div className='col-sm-6 d-flex align-items-stretch'>
                            <div className='alt-features-item border-left mt-0 wow fadeScaleIn' data-wow-delay='.5s'>
                                ...
                                <div className='alt-features-descr'>123 King Street, London W6 9JG, United Kingdom</div>
                            </div>
                        </div>
                        {/* End Contact Item */}
                    </div>
