...
export const features6 = [
    {
        ...
        description: "Ensure clarity and unity by aligning organizational goals with a compelling mission.",
        svgPath:
            "M48.5 17.5l-17.5 17.375-3.875-3.875 17.5-17.375zM60.125 13.625l3.875 3.875-33 32.875-15.25-15.375 3.75-3.875 11.5 11.375zM0 35l4-3.875 15.25 15.375-3.875 3.875z",
    },
    {
        title: "Market & Competitor Analysis",
        description: "Leverage insights to position your business strategically and seize opportunities.",
        svgPath:
            "M48.5 17.5l-17.5 17.375-3.875-3.875 17.5-17.375zM60.125 13.625l3.875 3.875-33 32.875-15.25-15.375 3.75-3.875 11.5 11.375zM0 35l4-3.875 15.25 15.375-3.875 3.875z",
    },
    {
        title: "Scalable Growth Plans",
        description: "Craft strategies that adapt to your business’s evolving needs.",
        svgPath:
            "M48.5 17.5l-17.5 17.375-3.875-3.875 17.5-17.375zM60.125 13.625l3.875 3.875-33 32.875-15.25-15.375 3.75-3.875 11.5 11.375zM0 35l4-3.875 15.25 15.375-3.875 3.875z",
    },
    {
        title: "Risk Mitigation Strategies",
        description: "Minimize uncertainties with proactive planning and robust solutions.",
        svgPath:
            "M48.5 17.5l-17.5 17.375-3.875-3.875 17.5-17.375zM60.125 13.625l3.875 3.875-33 32.875-15.25-15.375 3.75-3.875 11.5 11.375zM0 35l4-3.875 15.25 15.375-3.875 3.875z",
    },
];
...
export const features7 = [
    {
        ...
        description: "Pinpoint and target the most relevant audiences for your business.",
        svgPath:
            "M48.5 17.5l-17.5 17.375-3.875-3.875 17.5-17.375zM60.125 13.625l3.875 3.875-33 32.875-15.25-15.375 3.75-3.875 11.5 11.375zM0 35l4-3.875 15.25 15.375-3.875 3.875z",
    },
    {
        title: "Campaign Strategy & Execution",
        description: "Develop high-impact campaigns that connect with your audience effectively.",
        svgPath:
            "M48.5 17.5l-17.5 17.375-3.875-3.875 17.5-17.375zM60.125 13.625l3.875 3.875-33 32.875-15.25-15.375 3.75-3.875 11.5 11.375zM0 35l4-3.875 15.25 15.375-3.875 3.875z",
    },
    {
        title: "Digital Marketing",
        description: "Leverage digital platforms and tools to drive traffic and conversions.",
        svgPath:
            "M48.5 17.5l-17.5 17.375-3.875-3.875 17.5-17.375zM60.125 13.625l3.875 3.875-33 32.875-15.25-15.375 3.75-3.875 11.5 11.375zM0 35l4-3.875 15.25 15.375-3.875 3.875z",
    },
    {
        title: "Brand Positioning & Messaging",
        description: "Ensure consistent and effective brand communication that resonates with your target market.",
        svgPath:
            "M48.5 17.5l-17.5 17.375-3.875-3.875 17.5-17.375zM60.125 13.625l3.875 3.875-33 32.875-15.25-15.375 3.75-3.875 11.5 11.375zM0 35l4-3.875 15.25 15.375-3.875 3.875z",
    },
];
...
export const features8 = [
    {
        ...
        description: "Analyze and refine workflows to remove redundancies and boost operational speed.",
        svgPath:
            "M48.5 17.5l-17.5 17.375-3.875-3.875 17.5-17.375zM60.125 13.625l3.875 3.875-33 32.875-15.25-15.375 3.75-3.875 11.5 11.375zM0 35l4-3.875 15.25 15.375-3.875 3.875z",
    },
    {
        title: "Technology Integration",
        description: "Adopt modern tools to streamline communication and automate repetitive tasks.",
        svgPath:
            "M48.5 17.5l-17.5 17.375-3.875-3.875 17.5-17.375zM60.125 13.625l3.875 3.875-33 32.875-15.25-15.375 3.75-3.875 11.5 11.375zM0 35l4-3.875 15.25 15.375-3.875 3.875z",
    },
    {
        title: "Cross-Team Collaboration",
        description: "Enhance coordination and communication between departments for smoother operations.",
        svgPath:
            "M48.5 17.5l-17.5 17.375-3.875-3.875 17.5-17.375zM60.125 13.625l3.875 3.875-33 32.875-15.25-15.375 3.75-3.875 11.5 11.375zM0 35l4-3.875 15.25 15.375-3.875 3.875z",
    },
    {
        title: "Data-Driven Decision Making",
        description: "Leverage performance metrics to track improvements and sustain growth.",
        svgPath:
            "M48.5 17.5l-17.5 17.375-3.875-3.875 17.5-17.375zM60.125 13.625l3.875 3.875-33 32.875-15.25-15.375 3.75-3.875 11.5 11.375zM0 35l4-3.875 15.25 15.375-3.875 3.875z",
    },
];
...
export const features9 = [
    {
        ...
        description: "Identify new income streams, refine pricing models, and enhance revenue-generating processes.",
        svgPath:
            "M48.5 17.5l-17.5 17.375-3.875-3.875 17.5-17.375zM60.125 13.625l3.875 3.875-33 32.875-15.25-15.375 3.75-3.875 11.5 11.375zM0 35l4-3.875 15.25 15.375-3.875 3.875z",
    },
    {
        title: "Cost-Reduction Strategies",
        description: "Streamline operations to eliminate inefficiencies, cut unnecessary expenses, and enhance productivity.",
        svgPath:
            "M48.5 17.5l-17.5 17.375-3.875-3.875 17.5-17.375zM60.125 13.625l3.875 3.875-33 32.875-15.25-15.375 3.75-3.875 11.5 11.375zM0 35l4-3.875 15.25 15.375-3.875 3.875z",
    },
    {
        title: "Profitability Analytics",
        description: "Leverage data-driven insights to pinpoint opportunities and measure the impact of implemented strategies.",
        svgPath:
            "M48.5 17.5l-17.5 17.375-3.875-3.875 17.5-17.375zM60.125 13.625l3.875 3.875-33 32.875-15.25-15.375 3.75-3.875 11.5 11.375zM0 35l4-3.875 15.25 15.375-3.875 3.875z",
    },
    {
        title: "Scalable Financial Planning",
        description: "Develop flexible, long-term financial plans that grow alongside your business.",
        svgPath:
            "M48.5 17.5l-17.5 17.375-3.875-3.875 17.5-17.375zM60.125 13.625l3.875 3.875-33 32.875-15.25-15.375 3.75-3.875 11.5 11.375zM0 35l4-3.875 15.25 15.375-3.875 3.875z",
    },
];
